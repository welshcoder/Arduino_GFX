...
public:
    ...
    GFX_INLINE bool getStatus(LT7680_Status_Register_Mask v);
    bool isBusy();
    GFX_INLINE bool isNormalOperation();
    GFX_INLINE bool isDisplayRAMReady();
    GFX_INLINE bool isWriteFIFOFull();
    GFX_INLINE bool isWriteFIFOEmpty();
    ...
    GFX_INLINE LT7680_ColourDepth getImageColourDepth(LT7680_WindowSelection wnd);
